...
def runClient(host, port, buffer_size, image_path, timeout=0, save=False):
    tot_size = 0
...
if __name__ == '__main__':
    ...
    stats = runClient(args.host, args.port, args.buffer_size, args.image_path, args.timeout, args.save)
